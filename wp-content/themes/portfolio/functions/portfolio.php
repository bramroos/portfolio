...
function portfolio() { 
	...
	register_post_type( 'portfolio', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			...
			'add_new_item' => __('Add New Portfolio', 'jointswp'), /* Add New Display Title */
			'edit' => __( 'Edit', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __('Edit Portfolio', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Portfolio', 'jointswp'), /* New Display Title */
			'view_item' => __('View Portfolio', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Portfolios', 'jointswp'), /* Search Custom Type Title */ 
